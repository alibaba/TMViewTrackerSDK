...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    tabBarVC.tabBar.alpha = 0.5f;
    
    ViewController *tab1 = [ViewController new];
    tab1.title = @"tab1";
    
    TableViewController *tab2 =[TableViewController new];
    tab2.title = @"tab2";
    
    [tabBarVC setViewControllers:@[[[UINavigationController alloc] initWithRootViewController:tab1],
